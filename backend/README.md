...
## Project Structure
    ...
    ├── testappdeletion_dev_30876  # Django project configurations
...
1. Clone this repo and `cd testappdeletion_dev_30876`
...
2. Clone this repo and `cd testappdeletion_dev_30876`
